...
class ConnectionLiveData(private val ctxRef: WeakReference<Context>) : LiveData<Boolean>() {
    ...
    private var connectivityManager: ConnectivityManager = ctxRef.get()?.getSystemService(Context.CONNECTIVITY_SERVICE) as ConnectivityManager
        ...
        when {
            ...
            Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP -> lollipopNetworkAvailableRequest()
                ...
                if (Build.VERSION.SDK_INT < Build.VERSION_CODES.LOLLIPOP) {
                    ctxRef.get()?.registerReceiver(networkReceiver, IntentFilter("android.net.conn.CONNECTIVITY_CHANGE")) // android.net.ConnectivityManager.CONNECTIVITY_ACTION
                }
            }
        }
    }
